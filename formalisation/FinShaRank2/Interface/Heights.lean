...
normalisation dictionary (Proposition 3.13, (6)): the normalised
...
proof of Proposition 3.13 extracts.
...
## Contract for `ClassicalInputs` (`PrimeData`) and `prop_dictionary` (Proposition 3.13)
...
Paper statements quoted below: Proposition 3.13, (6), Lemma 3.7.
-/

namespace FinShaRank2

/-- **Height data at a split prime `p`** (paper Proposition 3.13,
(6)).
...
consequence forms the proof of Proposition 3.13 extracts.
...
structure HeightData (p : ℕ) [Fact p.Prime] where
  ...
  Birthday, 577–614].
  PAPER: Proposition 3.13 (`prop:dictionary`)(2), (6) (`eq:padicbsd`) (the factor
  `Reg_p/log_p(1+p)²`).
  STATUS: data. -/
  Reg_γ : ℚ_[p]
  ...
  PAPER: Proposition 3.13 (`prop:dictionary`)(2) ("the cyclotomic p-adic height pairing on `E(ℚ)`
  is nondegenerate").
  ...
  PAPER: Proposition 3.13 (`prop:dictionary`)(2), (6) (`eq:padicbsd`).
  ...
  Extracted in the proof of Proposition 3.13 from integrality of the p-adic
  ...
  577–614].
  PAPER: Proposition 3.13 (`prop:dictionary`) proof ("`Reg_γ ∈ ℤ_p`").
  ...
  proof of Proposition 3.13 extracts: `‖c2norm‖ = ‖Reg_γ‖ * ‖shaOrd‖`.
  ...
  *Algorithms for the arithmetic of elliptic curves using Iwasawa theory*, Math.
  ...
  Proposition 3.13 proof).
  PAPER: (6) (`eq:padicbsd`), Proposition 3.13 (`prop:dictionary`) proof.
  ...
  Mirrors Proposition 3.13 exactly: the normalised jet is a p-adic unit iff the
  ...
  `spr_padicBSD`).
  PAPER: Proposition 3.13 (`prop:dictionary`) (the stated equivalence (1) ⟺ (2)).
