...
normalisation dictionary (Proposition 4.13, (9)): the normalised
...
proof of Proposition 4.13 extracts.
...
## Contract for `ClassicalInputs` (`PrimeData`) and `prop_dictionary` (Proposition 4.13)
...
* `shaOrd` — the `#Ш(E/ℚ)[p^∞]` factor of (9), cast to `ℚ_[p]`; `ClassicalInputs`
  imposes `IsPUnit shaOrd ↔ Subsingleton SelmerData.ShaDual` (a p-power is a
  p-adic unit iff it is `1`).

Paper statements quoted below: Proposition 4.13, (9), Lemma 4.4.
-/

namespace FinShaRank2

/-- **Height data at a split prime `p`** (paper Proposition 4.13,
(9)).
...
consequence forms the proof of Proposition 4.13 extracts.
...
structure HeightData (p : ℕ) [Fact p.Prime] where
  ...
  rank-2 Mordell–Weil basis `{P₁, P₂}`, as it enters (9).
  ...
  Birthday, 577–614].
  PAPER: Proposition 4.13 (`prop:dictionary`)(2), (9) (`eq:padicbsd`) (the factor
  `Reg_p/log_p(1+p)²`).
  STATUS: data. -/
  Reg_γ : ℚ_[p]
  ...
  PAPER: Proposition 4.13 (`prop:dictionary`)(2) ("the cyclotomic p-adic height pairing on `E(ℚ)`
  is nondegenerate").
  STATUS: opaque assumption. -/
  heightNondeg : Prop
  /-- Proxy for the **`#Ш(E/ℚ)[p^∞]` order factor** of (9), realised
  ...
  SOURCE: (9) (`eq:padicbsd`) (`#Ш(E/ℚ)[p^∞]` factor).
  PAPER: Proposition 4.13 (`prop:dictionary`)(2), (9) (`eq:padicbsd`).
  ...
  SOURCE: (9) (`eq:padicbsd`) (the height-side prediction of `c₂(p)`).
  PAPER: Definition 4.2 (`def:c2tilde`), Proposition 4.13 (`prop:dictionary`)(1).
  STATUS: data (proxy; tied downstream). -/
  c2norm : ℚ_[p]
  /-- **Integrality of the regulator**: `‖Reg_γ‖ ≤ 1`, i.e. `v_p(Reg_γ) ≥ 0`.

  Extracted in the proof of Proposition 4.13 from integrality of the p-adic
  ...
  577–614].
  PAPER: Proposition 4.13 (`prop:dictionary`) proof ("`Reg_γ ∈ ℤ_p`").
  ...
  /-- **Leading-coefficient identity** ((9)), in the valuation form the
  proof of Proposition 4.13 extracts: `‖c2norm‖ = ‖Reg_γ‖ * ‖shaOrd‖`.
  ...
  *Algorithms for the arithmetic of elliptic curves using Iwasawa theory*, Math.
  ...
  Proposition 4.13 proof).
  PAPER: (9) (`eq:padicbsd`), Proposition 4.13 (`prop:dictionary`) proof.
  ...
  Mirrors Proposition 4.13 exactly: the normalised jet is a p-adic unit iff the
  ...
  `spr_padicBSD`).
  PAPER: Proposition 4.13 (`prop:dictionary`) (the stated equivalence (1) ⟺ (2)).
