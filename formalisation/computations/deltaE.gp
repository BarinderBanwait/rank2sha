...
\\ ---------------------------------------------------------------------------
\\ Computes the Eisenstein--Kronecker grade-<=2 jet package of Sec. 8:
...
{write(OUT, "delta_E phase-two results, E: y^2 = x^3 - 56x, f = (56), computed 2026-07-13");}
{write(OUT, "invariant sums: S01 ", S01, "  S02 ", S02, "  S11/A ", S11, "  S03 ", S03, "  S12/A ", S12, "  S21/A^2 ", S21);}
...
report(name, x, A2, B7) = {
  ...
  write(OUT, "== ", name, " ==");
  write(OUT, "sign ", sign(r), "  v2 ", v2, "  v7 ", v7, "  smallprimes ", Vec(hits), "  scanhits ", if(#scanhits == 0, "NONE", Str(Vec(scanhits))));
  write(OUT, "cofactor(all prime factors > 20000): ", rem);
};
